...
public partial class DevicePropertiesService : SonosBaseService {
  ...
  public DevicePropertiesService(Uri sonosUri, HttpClient? httpClient): base("DeviceProperties", "/DeviceProperties/Control", "/DeviceProperties/Event", sonosUri, httpClient) {}
